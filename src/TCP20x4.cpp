...
TCP20x4::TCP20x4(BBI2C& i2c, const TCP20x4Pcf8574Config& config)
    : device_(i2c, config), controller_(device_) {}

TCP20x4::TCP20x4(BBI2C& i2c, uint8_t i2cAddress, const TCP20x4PinMap& pinMap)
    : TCP20x4(i2c, TCP20x4Pcf8574Config::FromAddressAndPinMap(i2cAddress, pinMap)) {}
